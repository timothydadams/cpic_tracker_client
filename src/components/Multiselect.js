        ...
        >
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                'flex p-1 rounded-md border min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit dark:bg-zinc-900 [&_svg]:pointer-events-auto',
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              className='ml-2 h-4 w-4 cursor-pointer rounded-sm p-0.5 -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50'
                            >
                              <XCircle
                                className={cn(
                                  'h-3 w-3',
